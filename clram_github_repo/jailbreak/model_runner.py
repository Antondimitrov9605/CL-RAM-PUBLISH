...
class ModelRunner:
    ...
    def generate_response(self, prompt: str, temperature: float = 0.7,
                          max_tokens: int = 4096, stop: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            output = self.current_model(
                ...
                top_k=40,
                repeat_penalty=1.1,
                stop=stop if stop else ["Human:", "User:", "Assistant:", "\n\n\n"],
            ...
            # Also check if the response starts with common chat artifacts that might contain the prompt
            start_artifacts = ["User:", "Human:", "Assistant:", "System:"]
            for artifact in start_artifacts:
                if response_text.startswith(artifact):
                     # If it starts with Assistant:, we want to keep what follows. 
                     # If it starts with User:, it might be repeating the user turn.
                     pass 
